...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        rect = self.rect()
        path.addEllipse(PyQt6.QtCore.QRectF(rect.x(), rect.y(), rect.width(), rect.height()))
    ...
    def paintEvent(self, event):
        ...
        hour_angle = (hours * 30 + minutes / 2) % 360  # 360/12 = 30 degrees per hour, plus half a degree per minute
        painter.save()
        painter.translate(center)
